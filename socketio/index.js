...
module.exports = class SocketServer {
    ...
    newUser (data, callback, socket) {
      process.stdout.write("add new user :"+data._id+"\n")
    ...
    chat (data, socket) {
        process.stdout.write("data receiver: "+data.receiver+"\n");
        process.stdout.write("this.user: "+Object.keys(this.users)+"\n");
        ...
        if (data.receiver in this.users) {
            ...
            console.log("hahaID: "+data.receiver);
